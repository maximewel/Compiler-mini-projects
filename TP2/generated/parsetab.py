...
_lr_productions = [
  ...
  ('program -> statement ; program','program',3,'p_program','parser.py',27),
  ('statement -> assignement','statement',1,'p_statement','parser.py',31),
  ('statement -> expression','statement',1,'p_statement','parser.py',32),
  ('assignement -> VAR = expression','assignement',3,'p_assignement','parser.py',37),
  ('expression -> NUMBER','expression',1,'p_expression','parser.py',42),
  ('expression -> VAR','expression',1,'p_expression','parser.py',43),
  ('expression -> ( expression )','expression',3,'p_expression_num','parser.py',50),
  ('expression -> expression ADD_OP expression','expression',3,'p_expression_op','parser.py',54),
  ('expression -> expression MUL_OP expression','expression',3,'p_expression_op','parser.py',55),
  ('expression -> ADD_OP expression','expression',2,'p_expression_uminus','parser.py',59),
]
