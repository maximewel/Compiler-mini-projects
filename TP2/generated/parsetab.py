...
_lr_productions = [
  ...
  ('assignement -> IDENTIFIER = expression','assignement',3,'p_assignement','parser.py',34),
  ('expression -> NUMBER','expression',1,'p_expression','parser.py',39),
  ('expression -> IDENTIFIER','expression',1,'p_expression','parser.py',40),
